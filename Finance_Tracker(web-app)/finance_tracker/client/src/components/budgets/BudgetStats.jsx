...
import { PieChart, DollarSign, TrendingUp, AlertTriangle, Target, Wallet } from 'lucide-react'
import { useCurrency } from '../../contexts/CurrencyContext'

export function BudgetStats({ stats, isLoading }) {
  ...
  const statCards = [
    ...
    {
      title: 'Total Budget',
      value: formatAmount(stats?.totalBudget || 0),
    ...
    {
      title: 'Total Spent',
      value: formatAmount(stats?.totalSpent || 0),
    ...
    {
      title: 'Overall Usage',
      value: formatPercentage(stats?.overallPercentageUsed || 0),
      subtitle: 'Budget utilization',
      icon: AlertTriangle,
      gradient: stats?.overallPercentageUsed >= 80 ? 'gradient-danger' : 'gradient-primary',
      emoji: stats?.overallPercentageUsed >= 80 ? '⚠️' : '📊'
    }
  ]
